...
public class Random_objects {
	...
	public static String ciag_liczb(int n)
	{
	 ...
	 public static int randomInt(int ograniczenie)
	{
		return g.nextInt(ograniczenie);
	}
	
	public static char plec(String imie)
	{
	...
	public static double pensja(int pensja_od,int pensja_do)
	{
	...
	public static Pracownik_administracyjny pracownik_administracyjny()
	{
	...
	static public Pracownik_Badawczo_Dydaktyczny pracownik_badawczo_dydaktyczny()
	{
